from  transfervis_backend import handlers
import os
import tornado.web
import jinja2
...
class HelloWorldApplication(tornado.web.Application):
    def __init__(self):
        ...
        handlers_app = [
            (r"/page1", handlers.SecondPage),  #  second page
            # =============== Static ===============
            (r"/static/(.*)", tornado.web.StaticFileHandler),
            # =============== Main ===============
            (r"/", handlers.MainPage)  #  main page
        ]
        ...
        super(HelloWorldApplication, self).__init__(handlers_app, **settings)
